...
file_obj_in="$cDir/list/sce.CD8.list"
file_obj_in_fullPath="$cDir/list/sce.CD8.fullPath.list"
file_int_in="$cDir/list/sce.CD8.int.list"
file_limma_in="$cDir/list/sce.CD8.forLimma.list"
file_limma_out="$cDir/list/sce.CD8.limma.sc.list"
cellType="CD8"
...
gene_int_file="$cDir/../data/expression/CD8/integration/int.CD8.S35.gene.G1500.tb"
...
######################## 2.2 first run ########################
#### $gene_int_file contains genes used to obtain ../data/expression/CD8/integration/int.CD8.S35.sce.merged.rds
